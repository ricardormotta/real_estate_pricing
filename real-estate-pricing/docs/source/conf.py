...
# real_estate_pricing documentation build
...
from real_estate_pricing import __version__ as release

# -- Project information -----------------------------------------------------

project = "real_estate_pricing"
author = "Kedro"
...
htmlhelp_basename = "real_estate_pricingdoc"
...
latex_documents = [
    (
        master_doc,
        "real_estate_pricing.tex",
        "real_estate_pricing Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "real_estate_pricing",
        "Project real_estate_pricing codebase.",
        "Data-Science",
    )
]
